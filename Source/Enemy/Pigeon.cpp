...
void Pigeon::Init()
{
	...
	//テクスチャの読み込み
	mTexture.Load("Images/2dAction/Pigeon.png");
...
//プレイヤーと鳩の二点間の距離を返す処理
float Pigeon::_GetDistanceBetweenTwo() {
	return mDistanceX;
}

//プレイヤーと鳩の二点間の距離を測る処理
void Pigeon::_SetDistanceBetweenTwo() {
...
bool Pigeon::_IsInSafeView(float margin) {
	// カメラの中央座標を取得（ワールド座標）
